...
# Button interact
summon villager -34 5 -288.7 {Invulnerable:1b,NoAI:1b,Health:20f,NoGravity:1b,Silent:1b,Team:"NoPush",Rotation:[0f,0f],Tags:["guard_door","red","interact_box"],ActiveEffects:[{Id:14,Duration:2147483647,ShowParticles:0b},{Id:10,Duration:2147483647,Amplifier:255,ShowParticles:0b}]}
# Button marker
