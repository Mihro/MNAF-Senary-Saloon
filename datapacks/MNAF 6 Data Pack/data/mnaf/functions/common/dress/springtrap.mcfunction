...
# Head
replaceitem entity @s armor.head gold_ore

# Left Arm
replaceitem entity @s weapon.mainhand netherite_hoe{CustomModelData:17}

# Right Arm
replaceitem entity @s weapon.offhand netherite_hoe{CustomModelData:17}

# Chest
replaceitem entity @s armor.chest chainmail_chestplate{display:{Name:'"Springtrap"'}}

# Legs
replaceitem entity @s armor.legs chainmail_leggings{display:{Name:'"Springtrap"'}}

# Feet
replaceitem entity @s armor.feet chainmail_boots{display:{Name:'"Springtrap"'}}