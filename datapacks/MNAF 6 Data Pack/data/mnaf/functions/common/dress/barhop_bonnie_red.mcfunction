...
execute if entity @s[type=armor_stand] run data merge entity @s {CustomName:'"Barhop Bonnie Red"',DisabledSlots:4144896,Invisible:1b,Invulnerable:1b,Marker:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:0b,Tags:["animatronic","barhop_bonnie_red"]}

# Head
replaceitem entity @s armor.head netherite_hoe{CustomModelData:52}
...
# Chest
replaceitem entity @s armor.chest chainmail_chestplate{display:{Name:'"Barhop Bonnie Red"'}}

# Legs
replaceitem entity @s armor.legs chainmail_leggings{display:{Name:'"Barhop Bonnie Red"'}}

# Feet
replaceitem entity @s armor.feet chainmail_boots{display:{Name:'"Barhop Bonnie Red"'}}