...
execute if entity @s[type=armor_stand] run data merge entity @s {CustomName:'"Burnt Baby"',DisabledSlots:4144896,Invisible:1b,Invulnerable:1b,Marker:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:0b,Tags:["animatronic","burnt_baby"]}

# Head
replaceitem entity @s armor.head orange_shulker_box
...
replaceitem entity @s weapon.mainhand netherite_hoe{CustomModelData:18}

# Right Arm
replaceitem entity @s weapon.offhand netherite_hoe{CustomModelData:18}

# Chest
replaceitem entity @s armor.chest chainmail_chestplate{display:{Name:'"Burnt Baby"'}}

# Legs
replaceitem entity @s armor.legs chainmail_leggings{display:{Name:'"Burnt Baby"'}}

# Feet
replaceitem entity @s armor.feet chainmail_boots{display:{Name:'"Burnt Baby"'}}